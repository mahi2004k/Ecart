...
export const updateUser = async (req, res) => {
    try {
        ...
        // 🔴 FIX 1: prevent crash if req.user is undefined
        if (!loggedInUser) {
        ...
        // 🔴 FIX 3: safe file check (avoid req.file.buffer crash)
        ...
        // ✅ safe updates (no overwriting with undefined)
        ...
        // 🔴 FIX 4: role should not overwrite blindly
        if (role) {
            user.role = role;
        }
